...
## Project Structure
    ...
    ├── testapiautoteammem_110632  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_110632`
...
2. Clone this repo and `cd testapiautoteammem_110632`
